...
/**
 * 对于java中读取所依赖的jar包，它是先从根路径下读取自定义的包文件，
 * 在找不到的情况下，再去读取maven依赖下的jar包
 * 
 * 
 * 所以对于我们想要修改别人的代码，如果有源文件的情况下，我们可以直接这样操作
 */
...
public class ReportNGUtils
{
    ...
    //获取图片信息的方法--》只提取图片下信息
    public static String getImageString(String logInfoStr) {
    ...
    //移除图片的方法--》如果获取到图片，就把它置空
    public static String removeImage(String logInfoStr) {
    	String regex = "<img .*>.*</img>";
    ...
    public static void main(String[] args) {
    	String string = "aaaaaaabbbbbb<img src='http://127.0.0.1:8080/screenshot/register/IMG_1382.JPG></img>";
		String regex="<img .*>.*</img>";
		System.out.println(string);
		System.out.println(getImageString(string));
		System.out.println(removeImage(string));
	}
    /**
